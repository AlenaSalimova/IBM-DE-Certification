...
# Connect to MySQL
connection = mysql.connector.connect(user='root', password='MTE5ODItc2FsaW1v',host='127.0.0.1',database='sales')
...
dsn_pwd ='MjIzMTUtc2FsaW1v'      # e.g. "7dBZ3wWt9XN6$o0J"
...
def get_last_rowid():
    ...
    return cursor_postgres.fetchone()
...
def get_latest_records(rowid):
    ...
    cursor_mysql.execute(SQL,rowid)
...
def insert_records(records):
    for row in records:
        ...
        cursor_postgres.execute(SQL, row)
        conn.commit()
